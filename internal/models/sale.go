...
type Sale struct {
	...
	CustomerName  *string `gorm:"type:varchar(200)"                                                         json:"customer_name,omitempty"`
	CustomerPhone *string `gorm:"type:varchar(30)"                                                          json:"customer_phone,omitempty"`
	ShippingAddr  *string `gorm:"type:text"                                                                 json:"shipping_addr,omitempty"`
